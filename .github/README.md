...
[`@aws-sdk/client-route53-recovery-control-config`](https://www.npmjs.com/package/@aws-sdk/client-route53-recovery-control-config/v/3.1109.0).
...
- @aws-sdk/client-route53-recovery-control-config - [https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-control-config](https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-control-config)
- @aws-sdk/client-route53-recovery-control-config v3.1109.0 - [https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-control-config&version=3.1109.0](https://cloud-sdk-builds.github.io/?sdk=client-route53-recovery-control-config&version=3.1109.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-control-config@3.1109.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uDlVb+YfZ3cJLCZPGcnczUufHJ9ZWGtl2gzmOCQbAGrhBXe+9ESRKCRqxrnSZBQY
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-control-config/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-route53-recovery-control-config": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-control-config@3.1109.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-route53-recovery-control-config@3.1109.0/index.min.mjs": "sha384-uDlVb+YfZ3cJLCZPGcnczUufHJ9ZWGtl2gzmOCQbAGrhBXe+9ESRKCRqxrnSZBQY"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-route53-recovery-control-config";
...
```
https://github.com/cloud-sdk-builds/client-route53-recovery-control-config/blob/refs/tags/3.1109.0/LICENSE
```
